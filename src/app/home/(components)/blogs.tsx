...
function BlogsSection() {
  ...
  return (
    <section className="blogs py-5 md:py-10 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-0 md:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 pt-5 md:pt-10 lg:grid-cols-3">
            {posts.map((post) => (
              <div
                key={post.id}
                className="bg-white border border-gray-100  dark:border-white/20 dark:bg-black/40 overflow-hidden transition-all duration-200 ease-in-out "
              >
                <div className="relative">
                  ...
                  <div className="px-4 py-6">
                    ...
                    <div className="mt-4">
                      <a href="page-blog-details.html" className="text-primary">
